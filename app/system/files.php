...
if(!in_array("files", $userApp['permissions']) || !in_array("site", $userApp['permissions']) || !in_array("router", $userApp['permissions']) || !in_array("mysql", $userApp['permissions']))
  ...
  $root_path = PATH_APP;//$_SERVER['DOCUMENT_ROOT'] . '/' . $root_url; //templates default ??
  ...
  <div class="path main-nav">
          ...
          <?php
          $path = fm_clean_path($path);
          $root_url = "<a href='dashboard.php'><i class='fa fa-home' aria-hidden='true' title='Dashboard'></i></a> <i class='fa fa-caret-right'></i> <a href='?p='><i class='fa fa-folder' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
